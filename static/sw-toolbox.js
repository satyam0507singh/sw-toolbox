...
*/(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.notify = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*
...
var notifySw = require('./sw-notify');
...
function fetchConfig() {
  var brandid = notifyvisitors_brandid || typeof undefined;
  if (brandid ==='undefined') {
    return new Promise(function (resolve, reject) {
      resolve(null);
    })
  } else {
    return fetch('https://devpush.notifyvisitors.com/pwa/sw/notification?brandid=' + notifyvisitors_brandid)
...
},{"./idb-cache-expiration":2,"./options":4,"./sw-notify":13}],2:[function(require,module,exports){
/*
...
},{"./helpers":1,"./options":4,"./router":6,"serviceworker-cache-polyfill":17}],4:[function(require,module,exports){
/*
	Copyright 2015 Google Inc. All Rights Reserved.
...
},{"path-to-regexp":16}],6:[function(require,module,exports){
/*
  Copyright 2014 Google Inc. All Rights Reserved.
...
function notifyInit(configObj) {
    ...
    new Notify().init(configObj);
}

module.exports = {
    notifyInit: notifyInit
}
},{"./helpers":1,"./options":4,"./router":6}],14:[function(require,module,exports){
/*
  Copyright 2014 Google Inc. All Rights Reserved.
...
},{"./helpers":1,"./listeners":3,"./options":4,"./router":6,"./strategies":10}],15:[function(require,module,exports){
