...
var notify_toolbox = function (configOption) {
    ...
    routers.default = strategies[getDefaultHandler()];
...
var getDefaultHandler = function () {
    return globalOptions.defaultHandler;
}
var getDefaultCacheName = function () {
    return globalOptions.cache.name;
}
var getDefaultMaxAge = function () {
    return globalOptions.cache.maxAgeSeconds;
}
var getDefaultMaxLimit = function () {
    return globalOptions.cache.maxEntries;
}
...
var setDefault = function (configOption) {
    globalOptions.debug = configOption.debug;
    globalOptions.cache.name = configOption.cache.name;
    globalOptions.cache.maxAgeSeconds = configOption.cache.maxAge;
    globalOptions.cache.maxEntries = configOption.cache.maxLimit;
    globalOptions.defaultHandler = configOption.defaultHandler;
    globalOptions.preCacheItems = configOption.preCache;
    globalOptions.navigationFallback = configOption.navigationFallback;
}
...
var add = function (regex, handler, maxAge, maxLimit, cacheName, origin, requestType) {
    if (typeof regex === 'string' && regex.length) {
        if (typeof origin === 'string' && origin.length) {
            routers[requestType](
                regex,
                strategies[handler] || getDefaultHandler(),
                {
                    'cache':
                    {
